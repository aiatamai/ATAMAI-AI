...
from atamai_ai.utils import logger
from atamai_ai.utils.audit import AuditLevel, AuditLoggingMiddleware
from atamai_ai.utils.logger import start_logger
from atamai_ai.socket.main import (
    MODELS,
    app as socket_app,
...
from atamai_ai.routers.retrieval import (
...
from atamai_ai.internal.db import ScopedSession, engine, get_session

from atamai_ai.models.functions import Functions
from atamai_ai.models.models import Models
from atamai_ai.models.users import UserModel, Users
from atamai_ai.models.chats import Chats
...
from atamai_ai.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
    get_filtered_models,
)
from atamai_ai.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
    chat_action as chat_action_handler,
)
from atamai_ai.utils.embeddings import generate_embeddings
from atamai_ai.utils.middleware import process_chat_payload, process_chat_response
from atamai_ai.utils.access_control import has_access

from atamai_ai.utils.auth import (
    get_license_data,
...
from atamai_ai.utils.plugin import install_tool_and_function_dependencies
from atamai_ai.utils.oauth import (
...
from atamai_ai.utils.security_headers import SecurityHeadersMiddleware
from atamai_ai.utils.redis import get_redis_connection

from atamai_ai.tasks import (
...
from atamai_ai.utils.redis import get_sentinels_from_env
...
v{VERSION} - Your AI Assistant powered by Atamai AI
{f"Commit: {WEBUI_BUILD_HASH}" if WEBUI_BUILD_HASH != "dev-build" else ""}
https://github.com/aiatamai/atamai-ai
"""
)
...
if ENABLE_OTEL:
    from atamai_ai.utils.telemetry.setup import setup as setup_opentelemetry
        ...
        if request.method == "GET":
            ...
            if "shared" in query_params and len(query_params["shared"]) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from atamai_ai.retrieval.loaders.youtube import _parse_video_id
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Atamai AI.
