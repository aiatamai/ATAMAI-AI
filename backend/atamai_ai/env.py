...
# ATAMAI_DIR should be the directory where env.py resides (atamai_ai/)
...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Atamai AI")
if WEBUI_NAME != "Atamai AI":
    WEBUI_NAME += " (Atamai AI)"
...
try:
    ...
    changelog_content = (pkgutil.get_data("atamai_ai", "CHANGELOG.md") or b"").decode()
...
if FROM_INIT_PY:
    ...
    if DATA_DIR.exists() and DATA_DIR != NEW_DATA_DIR:
        ...
        shutil.make_archive(DATA_DIR.parent / "atamai_ai_data", "zip", DATA_DIR)
