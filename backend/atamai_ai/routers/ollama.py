...
from atamai_ai.utils.headers import include_user_info_headers
...
from atamai_ai.utils.payload import (
...
async def send_post_request(
    ...
    try:
        ...
        if r.ok is False:
            try:
                ...
                raise HTTPException(
                    ...
                    detail=f"Atamai AI: Server Connection Error",
                )
        ...
        raise HTTPException(
            ...
            detail=detail if e else "Atamai AI: Server Connection Error",
        )
    finally:
        if not stream:
            await cleanup_response(r, session)
...
async def verify_connection(
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="Atamai AI: Server Connection Error"
            )
        except Exception as e:
    ...
    if url_idx is None:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "Atamai AI: Server Connection Error",
            )
...
async def get_openai_models(
    ...
    if url_idx is None:
        ...
        try:
            ...
            log.exception(e)
            error_detail = "Atamai AI: Server Connection Error"
            if r is not None:
                try:
                    res = r.json()
                    if "error" in res:
