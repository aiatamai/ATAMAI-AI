...
from atamai_ai.env import PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS, OFFLINE_MODE
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from atamai_ai.utils",
        "from apps": "from atamai_ai.apps",
        "from main": "from atamai_ai.main",
        "from config": "from atamai_ai.config",
    }
