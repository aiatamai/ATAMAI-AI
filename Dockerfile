...
# IMPORTANT: If you change the embedding model (sentence-transformers/all-MiniLM-L6-v2) and vice versa, you aren't able to use RAG Chat with your previous documents loaded in Atamai AI! You need to re-embed them.
...
ARG BUILD_HASH
ENV ATAMAI_BUILD_VERSION=${BUILD_HASH}
ENV DOCKER=true
