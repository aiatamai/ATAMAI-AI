	...
	>
		...
		>
			<div class="pb-1.5">
				...
				>
					<button
						class="flex rounded-xl hover:bg-gray-100/70 dark:hover:bg-gray-800/50 transition group {isWindows
							? 'cursor-pointer'
							: 'cursor-[e-resize]'}"
			...
			<div class="-mt-[0.5px]">
				<div class="">
					<Tooltip content={$i18n.t('New Chat')} placement="right">
						<a
							class=" cursor-pointer flex rounded-xl hover:bg-gray-100/70 dark:hover:bg-gray-800/50 transition group"
							href="/"
							draggable="false"
							on:click={async (e) => {
			...
			>
				<div class="pb-1.5">
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<a
							id="sidebar-new-chat-button"
							class="group grow flex items-center space-x-3 rounded-2xl px-2.5 py-2 hover:bg-gray-100/70 dark:hover:bg-gray-800/50 transition outline-none"
							href="/"
							draggable="false"
							on:click={newChatHandler}
							aria-label={$i18n.t('New Chat')}
					...
					{#if ($config?.features?.enable_notes ?? false) && ($user?.role === 'admin' || ($user?.permissions?.features?.notes ?? true))}
						<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
							<a
								...
								class="grow flex items-center space-x-3 rounded-2xl px-2.5 py-2 hover:bg-gray-100/70 dark:hover:bg-gray-800/50 transition"
								href="/notes"
