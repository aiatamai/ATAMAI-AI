<script>
	...
	import { ATAMAI_NAME, config, user, showSidebar } from '$lib/stores';
...
> 
> Atamai AI is completely free to use as-is, with no restrictions or hidden limits, and we'd love to keep it that way. 🌱  
>
