<script lang="ts">
	...
	import { ATAMAI_NAME, config, mobile, models as _models, settings, user } from '$lib/stores';
	...
	const shareModelHandler = async (model) => {
		toast.success($i18n.t('Redirecting you to Atamai AI Community'));
	...
	{#if $config?.features.enable_community_sharing}
		<div class=" my-16">
			<div class=" text-xl font-medium mb-1 line-clamp-1">
				{$i18n.t('Made by Atamai AI Community')}
			</div>
